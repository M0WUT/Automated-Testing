...
class GainFlatnessWithSweptFrequency(BaseTest):
    ...
    def generate_measurement_points(self):
        ...
        logging.info(
            "Generated datapoints for Frequency swept gain flatness test"
        )
        return self.measurements

    def process_results(self, results):
        logging.info(
            "Processing results for Frequency swept gain flatness test"
        )
        ...
        ws.merge_range(
            0, 0, 1, 0, "Input Power (dBm)", merge_format
        )
        ...
        for f in measuredFrequencies:
            ...
            for x in validPoints:
                ...
                ws.write(
                    2 + rowIndex, columnIndex, x.outputPower
                )

                ws.write(
                    2 + rowIndex, columnIndex + 1, gain
                )
