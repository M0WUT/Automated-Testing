...
class BasicGainFlatness(BaseTest):
    ...
    def generate_measurement_points(self):
        ...
        logging.info("Generated datapoints for Basic gain flatness test")
        return self.measurements

    def process_results(self, results):
        logging.info("Processing results for Basic gain flatness test")
        ...
        chart = results.excelFile.add_chart({"type": "scatter", "subtype": "smooth"})
        ...
        chart.set_y_axis({"name": "Gain (dB)", "crossing": -200})
