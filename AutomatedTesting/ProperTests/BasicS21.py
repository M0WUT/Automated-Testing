...
class BasicS21(BaseTest):
    def __init__(
        self, freqRange, measurementPower, gateVoltage=None, drainVoltage=None
    ):
    ...
    def generate_measurement_points(self):
        ...
        logging.info("Generated datapoints for Basic S21 test")
        return self.measurements

    def process_results(self, results):
        logging.info("Processing results for Basic S21 test")
